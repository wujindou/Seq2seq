...
class Seq2seq(object):
    ...
    def __init__(self, config, tokenizer, useTeacherForcing=True, useAttention=True, useBeamSearch=1,use_copynet=True):
        ...
        if useBeamSearch > 1:
            ...
            gradients, _ = tf.clip_by_global_norm(grads, clip_norm=5.0)
